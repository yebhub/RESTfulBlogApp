...
exports.RookDebuggerPermanentlyClosedException = RookDebuggerPermanentlyClosedException;
...
exports.RookLoggingServiceNotFound = RookLoggingServiceNotFound;
exports.RookMessageQueueFull = RookMessageQueueFull;
exports.RookMessageSizeExceeded = RookMessageSizeExceeded;
...
function RookOperationReadOnly(operationType) {
  ToolException.call(this, util.format('Operation \'%s\' does not support write', operationType), {
...
function RookDebuggerPermanentlyClosedException() {
  ToolException.call(this, 'Disabled for safety reasons (too many scripts)');
}

setExceptionPrototype(RookDebuggerPermanentlyClosedException);
...
function RookMessageSizeExceeded(messageSize, maxMessageSize) {
  ToolException.call(this, util.format("Message size of %d exceeds max size limit of %d. " + "Consider changing the depth of collection and trying again.", messageSize, maxMessageSize), {
    messageSize,
    maxMessageSize
  });
}

setExceptionPrototype(RookMessageSizeExceeded);

function RookMessageQueueFull() {
  ToolException.call(this, 'Breakpoint was ignored because the message queue is full');
}

setExceptionPrototype(RookMessageQueueFull);

function RookLoggingServiceNotFound() {
  ToolException.call(this, 'Log breakpoint was ignored because the logging service was not found. Verify the environment variable is set properly.');
}

setExceptionPrototype(RookLoggingServiceNotFound);
